...
<div className="flex items-center justify-center p-12 ml-48">
  ...
  <div className="mx-auto w-full max-w-[550px] bg-white shadow-2xl">
    ...
    <div className="mb-4">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" placeholder="Travel Location"/>
    </div>
