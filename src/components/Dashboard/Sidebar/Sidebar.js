    ...
    <div>
        <div className="-mx-6 px-6 py-4">
            <Link href="#" title="home">
                <h1 classNameName='font-bold text-2xl mb-8 text-center italic text-zinc-700'>Cholo Bangladesh</h1>
            </Link>
        </div>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
            <li>
                <Link to="/dashboard" aria-label="dashboard" className="relative px-4 py-3 
            ...
            <li>
                <Link to = "/tripDash" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Trip Details</span>
                </Link>
            </li>
            <li>
                <Link to ="/tripData" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span className="group-hover:text-gray-700">Trip Data</span>
                </Link>
            </li>
            <li>
                <Link to ="./offerDash" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Offer</span>
                </Link>
            </li>

             <li>
                <Link to = '/offerData' className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span className="group-hover:text-gray-700">Offer Data</span>
                </Link>
            </li> 

            <li>
                <Link to = '/servicesDash' className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path className="fill-current text-gray-300 group-hover:text-cyan-300" d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
                        <path className="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd" />
                    </svg>
            ...
            <li>
                <Link to = '/servicesData' className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path className="fill-current text-gray-300 group-hover:text-cyan-300" d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
                        <path className="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd" />
                    </svg>
                    <span className="group-hover:text-gray-700">Services Data</span>
                </Link>
            </li> 


            <li>
                <Link to = '/users' className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path className="fill-current text-gray-300 group-hover:text-cyan-300" d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
                        <path className="fill-current text-gray-600 group-hover:text-cyan-600" fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd" />
                    </svg>
