                      ...
                      {bookings?.map((booking) => (
                        <tr>
                          ...
                          <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                            <div class="">
                              {booking?.paid === true ? (
                                <div className="bg-emerald-100/60 text-emerald-500 inline-flex items-center px-3 py-1 rounded-full gap-x-2 dark:bg-gray-800 ">
                                  <svg
                                    width="12"
                                    height="12"
                                    viewBox="0 0 12 12"
                                ...
                                <h2 className="px-2 py-1 rounded-full text-xs bg-red-400">
                                  Not Paid
                                </h2>
                              )}
                            </div>
