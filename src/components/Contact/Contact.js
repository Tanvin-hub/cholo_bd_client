...
const Contact = () => {
  return (
    <section className="relative overflow-hidden bg-white my-20 lg:py-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-24 lg:w-1/2 xl:w-6/12">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12 pt-10">
            <div className="relative rounded-lg border border-red-200 p-8 shadow-lg sm:p-12">
              <form>
                <div className="mb-6">
                  <input
                    type="text"
