      ...
      rounded-2xl bg-white text-black shadow-xl">
        <form className="grid grid-cols-4 gap-6 items-center">
          ...
          <BsFillTelephoneFill />
            ...
            <label className="font-medium text-xl ml-[88px] text-gray-600 ">Phone</label>
          ...
          <MdLocationOn />
            ...
            <label className="font-medium text-xl ml-20 text-gray-600 ">Address</label>
          ...
          <BsFillClockFill />
            ...
            <label className="font-medium text-xl ml-12 text-gray-600">Opening Time</label>
               <h1 className=' mt-1 font-semibold text-lg ml-6 text-gray-600'>10:00 am to 23:00 pm</h1>
          </div>
    ...
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      <div>
        ...
        <div className="mt-2.5">
          <input type="text" name="first-name" id="first-name" autocomplete="given-name"  placeholder='Enter Your Name'className="block w-full  border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"/>
        </div>
      </div>

      <div>
        <label for="last-name" className="block text-sm font-semibold leading-6 text-gray-900">Email</label>
        <div className="mt-2.5">
        <input type="email" name="email" id="email" autocomplete="email" placeholder='Enter Your Email' className="block w-full  border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400   sm:text-sm sm:leading-6"/>
        </div>
      </div>
      ...
      <div className="sm:col-span-2">
        ...
        <div className="mt-2.5">
          <textarea name="message" id="message" rows="4" placeholder='Enter Your Message' className="block w-full  border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2  sm:text-sm sm:leading-6"></textarea>
        </div>
      </div>
